...
ifeq ($(findstring --network minato,$(ARGS)),--network minato)
	NETWORK_ARGS := --rpc-url $(MINATO_RPC_URL) --account sepolia --broadcast --verify --verifier blockscout --verifier-url https://soneium-minato.blockscout.com/api/ -vvvv
endif
